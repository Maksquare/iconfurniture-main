...
export default function AdminLoginScreen({ onLoginSuccess }: AdminLoginScreenProps) {
  ...
  return (
    <div className="min-h-screen bg-[#111111] text-white flex flex-col justify-between relative overflow-hidden selection:bg-[#869e32] selection:text-white">
      {/* Ambient background glows */}
      <div className="absolute -top-40 -left-40 w-96 h-96 bg-[#869e32]/15 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute -bottom-40 -right-40 w-96 h-96 bg-[#869e32]/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <main className="flex-1 flex items-center justify-center p-4 sm:p-6 z-10">
        ...
        >
          {/* Top gradient line */}
          <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[#869e32] to-transparent" />

          {/* Header */}
          <div className="text-center space-y-4 mb-8">
            {/* Brand Logo */}
            <div className="mx-auto w-20 h-20 rounded-2xl bg-white/5 border border-[#869e32]/30 p-2 flex items-center justify-center shadow-[0_0_40px_rgba(18, 73, 3,0.2)]">
              <Image
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-[#869e32] focus:bg-white/8 focus:ring-2 focus:ring-[#869e32]/20 text-sm text-white placeholder-stone-600 transition-all outline-none"
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••••••"
                  className="w-full pl-10 pr-11 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-[#869e32] focus:bg-white/8 focus:ring-2 focus:ring-[#869e32]/20 text-sm text-white placeholder-stone-600 transition-all outline-none"
                />
                <button
                  type="button"
            ...
            <div className="flex items-center gap-1.5 text-xs text-stone-500">
              <ShieldCheck className="w-3.5 h-3.5 text-[#869e32]" />
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3.5 px-6 rounded-2xl bg-[#869e32] hover:bg-[#0e3802] disabled:opacity-50 text-white font-bold text-sm shadow-lg shadow-[#869e32]/30 hover:shadow-[#869e32]/50 transition-all flex items-center justify-center gap-2 cursor-pointer group"
            >
              {isLoading ? (
