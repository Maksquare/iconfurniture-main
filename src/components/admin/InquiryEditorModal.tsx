            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-xl border border-stone-300 focus:border-[#869e32] text-sm text-stone-900"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-xl border border-stone-300 focus:border-[#869e32] text-sm font-mono text-stone-900"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  <span className="absolute right-3 top-1/2 -translate-y-1/2 text-xs font-mono font-bold text-[#869e32]">
                    ETB
                  </span>
                </div>
              </div>
                ...
                {(
                  ...
                  <button
                    ...
                    className={`py-2 px-2 rounded-xl text-[11px] font-semibold border transition-all cursor-pointer ${
                      status === st.id
                        ? 'bg-[#869e32] text-white border-[#869e32] shadow-sm'
