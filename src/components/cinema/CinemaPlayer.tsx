    ...
    <div className={`space-y-6 ${isTheaterMode ? 'relative z-50' : ''}`}>
      ...
      <div
        ...
        className={`relative rounded-3xl overflow-hidden bg-[#0e0e0e] border border-white/10 shadow-2xl group select-none flex items-center justify-center min-h-[460px] sm:min-h-[580px] lg:min-h-[660px] max-h-[82vh] ${
          isTheaterMode ? 'relative z-50 ring-2 ring-[#869e32]/50 shadow-[0_0_90px_rgba(18, 73, 3,0.35)]' : ''
        }`}
      >
        ...
        <div className="absolute inset-0 bg-radial from-[#869e32]/15 via-black/60 to-[#0e0e0e] opacity-90 pointer-events-none -z-10" />
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none opacity-20 select-none -z-10">
          ...
          <div className="mt-2 flex items-center gap-3">
            <span className="h-px w-12 bg-gradient-to-r from-transparent via-[#869e32] to-transparent" />
        ...
        <AnimatePresence>
          {!isPlaying && (
            ...
            >
              <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-white/15 backdrop-blur-md border border-white/30 flex items-center justify-center text-white shadow-2xl hover:scale-110 hover:bg-[#869e32] transition-all duration-300 group/btn">
          ...
          {controlsVisible && (
            ...
            >
              <div className="flex items-center gap-3">
                <span className="w-2 h-2 rounded-full bg-[#869e32] animate-pulse shadow-[0_0_8px_#869e32]" />
                <div>
                  <div className="text-[10px] uppercase tracking-widest text-[#869e32] font-mono font-bold">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className={`p-2 rounded-full backdrop-blur-md text-xs transition-all cursor-pointer border ${
                    isTheaterMode
                      ? 'bg-[#869e32] text-white border-[#869e32]'
                ...
                >
                  {copiedLink ? <Check className="w-4 h-4 text-[#869e32]" /> : <Share2 className="w-4 h-4" />}
                </button>
              </div>
            </motion.div>
          )}
          ...
          {controlsVisible && (
            ...
            >
              ...
              >
                {/* Buffered/Fill bar */}
                <div
                  className="h-full bg-gradient-to-r from-[#869e32] to-[#a8c950] rounded-full relative"
                  style={{ width: `${(currentTime / (duration || 1)) * 100}%` }}
                >
                  {/* Glowing Thumb Handle */}
                  <span className="absolute right-0 top-1/2 -translate-y-1/2 w-3.5 h-3.5 rounded-full bg-white shadow-[0_0_10px_#869e32] scale-0 group-hover/bar:scale-100 transition-transform" />
                </div>
                ...
                <div className="flex items-center gap-3 sm:gap-4">
                  ...
                  <div className="flex items-center gap-2 group/vol">
                    ...
                    <input
                      ...
                      className="w-16 sm:w-20 accent-[#869e32] h-1 bg-white/20 rounded-lg cursor-pointer"
                    />
                  </div>
      ...
      <div className="p-6 sm:p-8 rounded-3xl bg-white border border-stone-200/80 shadow-sm flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        <div className="space-y-2 max-w-2xl">
          <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-[#869e32]">
        ...
        <div className="flex flex-col sm:flex-row lg:flex-col gap-3 shrink-0">
          <a
            ...
            className="px-6 py-3 rounded-full bg-[#1A1A1A] hover:bg-[#869e32] text-white text-xs uppercase tracking-widest font-bold transition-all shadow-md flex items-center justify-center gap-2 cursor-pointer group"
          >
