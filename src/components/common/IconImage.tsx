  ...
  if (hasError || !src) {
    return (
      ...
      >
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(133,159,60,0.18)_0%,transparent_70%)] pointer-events-none" />

        {/* Diagonal Subtle Watermark Background Patterns */}
        <div className="absolute inset-0 opacity-[0.04] bg-[radial-gradient(#859F3C_1px,transparent_1px)] [background-size:16px_16px] pointer-events-none" />
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center space-y-3">
          ...
          <div className="space-y-1">
            <div className="font-serif text-xs font-semibold uppercase tracking-[0.2em] text-[#859F3C]">
              {fallbackTitle}
            </div>
        ...
        <span className="absolute top-3 left-3 w-3 h-3 border-t border-l border-[#859F3C]/40" />
        <span className="absolute top-3 right-3 w-3 h-3 border-t border-r border-[#859F3C]/40" />
        <span className="absolute bottom-3 left-3 w-3 h-3 border-b border-l border-[#859F3C]/40" />
        <span className="absolute bottom-3 right-3 w-3 h-3 border-b border-r border-[#859F3C]/40" />
      </div>
    );
  }
