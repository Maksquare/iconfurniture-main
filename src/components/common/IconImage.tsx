  ...
  if (hasError || !src) {
    return (
      ...
      >
        ...
        <div className="absolute inset-0 opacity-[0.04] bg-[radial-gradient(#124903_1px,transparent_1px)] [background-size:16px_16px] pointer-events-none" />
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center space-y-3">
          ...
          <div className="space-y-1">
            <div className="font-serif text-xs font-semibold uppercase tracking-[0.2em] text-[#124903]">
              {fallbackTitle}
            </div>
        ...
        <span className="absolute top-3 left-3 w-3 h-3 border-t border-l border-[#124903]/40" />
        <span className="absolute top-3 right-3 w-3 h-3 border-t border-r border-[#124903]/40" />
        <span className="absolute bottom-3 left-3 w-3 h-3 border-b border-l border-[#124903]/40" />
        <span className="absolute bottom-3 right-3 w-3 h-3 border-b border-r border-[#124903]/40" />
      </div>
    );
  }
