      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 lg:pl-6">
            ...
            <blockquote className="p-4 border-l-2 border-[#869e32] bg-white/70 italic font-serif text-stone-800 text-sm rounded-r-xl">
              ...
              <cite className="block not-italic font-sans text-xs text-[#869e32] font-semibold mt-2 uppercase tracking-wider">
            ...
            <div className="pt-2">
              <Link
                href="/about"
                className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-[#1A1A1A] hover:text-[#869e32] group"
              >
