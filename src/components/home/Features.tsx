      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-stone-900 border border-stone-800 text-[#869e32] text-xs font-semibold uppercase tracking-widest rounded-full"
          >
          ...
          >
            ...
            <span className="text-[#869e32] italic font-light">for your whole family.</span>
          </motion.h2>
        </div>
