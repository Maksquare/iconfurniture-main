...
export default function Hero() {
  return (
    <section className="relative min-h-screen bg-[#FDFCF7] pt-28 pb-16 px-4 sm:px-6 lg:px-8 overflow-hidden flex flex-col justify-between">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-linear-to-tr from-[#869e32]/15 via-stone-200/50 to-[#869e32]/10 rounded-full blur-3xl -z-10 pointer-events-none" />
      ...
      <div className="relative w-full text-center z-10 pt-4">
        ...
        >
          Icon<span className="text-[#869e32]">furniture.</span>
        </motion.h1>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-3 space-y-8 flex flex-col justify-between z-20 order-2 lg:order-1">
            ...
            >
              <div className="flex items-center space-x-2">
                <div className="flex -space-x-2 overflow-hidden">
                  <div className="w-8 h-8 rounded-full bg-[#869e32] text-white flex items-center justify-center text-xs font-bold ring-2 ring-white">MK</div>
                  ...
                  <div className="w-8 h-8 rounded-full bg-[#869e32] text-white flex items-center justify-center text-xs font-bold ring-2 ring-white">SR</div>
                </div>
                <div className="flex items-center text-[#869e32] gap-0.5">
                  {[...Array(5)].map((_, i) => (
            ...
            >
              ...
              <Link
                href="/shop"
                className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-[#869e32] hover:underline"
              >
          ...
          >
            ...
            <motion.div
              ...
              className="absolute w-[320px] sm:w-[460px] h-[320px] sm:h-[460px] rounded-full border-2 border-dashed border-[#869e32]/30 pointer-events-none -z-10"
            />
            <motion.div
              animate={{ rotate: -360 }}
              transition={{ duration: 35, repeat: Infinity, ease: 'linear' }}
              className="absolute w-[380px] sm:w-[540px] h-[380px] sm:h-[540px] rounded-full border border-[#869e32]/40 pointer-events-none -z-10"
            />
          ...
          <div className="lg:col-span-3 space-y-8 flex flex-col justify-between items-start lg:items-end z-20 order-3">
            ...
            >
              <div className="flex justify-between items-center pb-2 border-b border-stone-100 text-xs text-stone-600 font-sans">
                ...
                <span className="font-mono text-[#869e32] font-semibold">/01</span>
              </div>
              <div className="flex justify-between items-center pb-2 border-b border-stone-100 text-xs text-stone-600 font-sans">
                <span className="font-medium">Honed Roman Travertine</span>
                <span className="font-mono text-[#869e32] font-semibold">/02</span>
              </div>
              <div className="flex justify-between items-center text-xs text-stone-600 font-sans">
                ...
                <span className="font-mono text-[#869e32] font-semibold">/03</span>
              </div>
            </motion.div>
            ...
            >
              <Link
                href="/shop"
                className="group inline-flex items-center gap-3 px-6 py-3.5 bg-[#869e32] hover:bg-[#0e3802] text-white font-bold text-xs uppercase tracking-wider rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1"
              >
