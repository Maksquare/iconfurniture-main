...
const FABRIC_PALETTE: ColorSwatch[] = [
  { name: 'Signature Olive', hex: '#859F3C', category: 'Icon Signature', roughness: 0.65, metalness: 0.05 },
...
export default function Icon3DFurniture({
  ...
  const [fabricColor, setFabricColor] = useState<string>('#859F3C');
  ...
  const fabricTargetColorRef = useRef(new THREE.Color('#859F3C'));
  ...
  const handleResetDefaults = () => {
    handleFabricColorChange('#859F3C', 'Signature Olive');
  ...
  return (
    <div className="relative w-full h-full flex flex-col justify-end">
      ...
      <div className="absolute bottom-4 sm:bottom-7 left-1/2 -translate-x-1/2 z-30 pointer-events-auto w-[94vw] max-w-lg sm:max-w-xl flex flex-col items-center select-none">
            ...
            >
                ...
                <div className="flex items-center bg-white/5 border border-white/10 rounded-xl p-0.5">
                  <button
                    ...
                    className={`px-3 py-1 text-[11px] font-medium rounded-lg transition-all ${
                      activeTab === 'fabric'
                        ? 'bg-[#859F3C] text-white shadow-xs font-semibold'
              ...
              <div className="space-y-3 mb-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] font-mono text-[#859F3C]">
                    {activeColorName}
                  </span>
                </div>
              ...
              <div className="flex items-center justify-between pt-3 border-t border-white/10 gap-2">
                <div className="flex items-center gap-2">
                  ...
                  {copiedHex && (
                    <span className="text-[10px] text-[#859F3C] font-semibold animate-pulse">
                      Copied!
                    </span>
                  )}
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="px-3.5 py-1 rounded-xl text-[11px] font-semibold bg-[#859F3C] text-white hover:bg-[#96b444] transition-colors shadow-xs"
                  >
                    Done
                  </button>
                </div>
        ...
        <motion.div
          layout
          className="flex items-center gap-2 sm:gap-3 backdrop-blur-2xl bg-[#141414]/90 border border-white/15 px-4 sm:px-5 py-2 sm:py-2.5 rounded-full shadow-[0_10px_35px_rgba(0,0,0,0.45)] text-white hover:border-[#859F3C]/50 transition-colors"
        >
          ...
          >
            ...
            <div className="w-5 h-5 rounded-full bg-white/10 flex items-center justify-center text-stone-300 ml-0.5">
              {isExpanded ? (
                ...
                <Sliders className="w-3 h-3 text-[#859F3C]" />
              )}
            </div>
          </button>
        </motion.div>
