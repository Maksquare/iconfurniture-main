  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/80 backdrop-blur-xl animate-in fade-in duration-300">
      <div className="relative w-full max-w-3xl rounded-3xl bg-[#1A1A1A] border border-white/15 p-6 sm:p-8 shadow-2xl text-white overflow-hidden">
        {/* Ambient Glow */}
        <div className="absolute top-0 right-0 w-80 h-80 bg-[#124903]/15 rounded-full blur-3xl pointer-events-none -z-10" />

        {/* Header */}
        <div className="flex items-center justify-between pb-5 border-b border-white/10">
          <div className="flex items-center gap-3">
            <span className="w-8 h-8 rounded-xl bg-[#124903] text-white flex items-center justify-center font-black text-sm shadow-[0_0_12px_rgba(18, 73, 3,0.5)]">
        ...
        <div className="mt-6 space-y-6">
          <div className="relative aspect-video rounded-2xl bg-black/60 border border-white/10 overflow-hidden flex flex-col items-center justify-center p-8 text-center group">
            <div className="w-16 h-16 rounded-full bg-[#124903] text-white flex items-center justify-center shadow-[0_0_24px_rgba(18, 73, 3,0.6)] group-hover:scale-110 transition-transform cursor-pointer">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5">
            <div className="p-4 rounded-2xl bg-white/5 border border-white/5 flex flex-col gap-2">
              <div className="flex items-center gap-2 text-[#124903] font-bold text-xs">
        ...
        <div className="mt-6 pt-4 border-t border-white/10 flex items-center justify-between">
          ...
          <Link
            href="/shop"
            onClick={onClose}
            className="px-5 py-2 rounded-full bg-[#124903] hover:bg-[#0e3802] text-white font-bold text-xs hover:shadow-[0_0_16px_rgba(18, 73, 3,0.5)] transition-all cursor-pointer"
          >
            Explore Catalog
          </Link>
        </div>
