...
export default function IconFeatures() {
  ...
  return (
    <section className="relative w-full min-h-screen bg-[#1A1A1A] text-white py-24 px-6 sm:px-10 flex flex-col justify-center items-center select-none overflow-hidden transition-colors duration-700">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[350px] bg-[#124903]/10 rounded-full blur-[140px] pointer-events-none -z-10" />
      <div className="absolute bottom-10 left-10 w-72 h-72 bg-[#124903]/5 rounded-full blur-[120px] pointer-events-none -z-10" />
      ...
      <div className="w-full max-w-6xl mx-auto flex flex-col items-center">
        ...
        <div className="text-center mb-16 sm:mb-20 max-w-3xl">
          <h2 className="text-3xl sm:text-5xl md:text-[54px] font-serif font-normal tracking-tight leading-[1.18] text-white">
            The art of the{' '}
            <span className="inline-flex items-center gap-1.5 px-5 py-1 rounded-full bg-[#124903] text-white font-serif font-bold tracking-tight text-3xl sm:text-5xl md:text-[50px] shadow-[0_0_24px_rgba(18, 73, 3,0.45)] my-1 align-middle">
              dining table.
            </span>
          </h2>
        </div>
            ...
            return (
              <div
                ...
                className={`group relative rounded-3xl p-7 flex flex-col justify-between min-h-[340px] transition-all duration-500 border ${
                  isHovered
                    ? 'bg-[#222222] border-[#124903]/70 shadow-[0_12px_40px_rgba(0,0,0,0.7),0_0_20px_rgba(18, 73, 3,0.2)] -translate-y-2'
                    : 'bg-[#141414] border-white/10 hover:border-white/20'
                }`}
              >
                {/* Top Section: Brand Primary Icon Box & Tag */}
                <div className="flex items-start justify-between">
                  <div className="w-13 h-13 rounded-2xl bg-[#124903] text-white flex items-center justify-center shadow-[0_4px_16px_rgba(18, 73, 3,0.35)] transition-transform duration-300 group-hover:scale-105">
                ...
                <div className="mt-8 flex flex-col gap-2.5">
                  <h3 className="text-xl font-bold font-serif tracking-tight text-white group-hover:text-[#124903] transition-colors flex items-center justify-between">
                    <span>{feature.title}</span>
                    <ArrowUpRight className="w-4 h-4 opacity-0 group-hover:opacity-100 -translate-x-1 group-hover:translate-x-0 transition-all text-[#124903]" />
                  </h3>
                ...
                <div className="mt-4 pt-4 border-t border-white/5 flex items-center justify-between text-xs text-stone-400">
                  <span className="flex items-center gap-1.5 text-stone-300">
                    <CheckCircle2 className="w-3.5 h-3.5 text-[#124903]" />
                    Lifetime Guarantee
                  </span>
                  <span className="font-mono text-[#124903] font-semibold">0{idx + 1}</span>
                </div>
              </div>
            );
          })}
        ...
        <div className="w-full mt-12 p-6 rounded-3xl bg-[#141414] border border-white/10 flex flex-col md:flex-row items-center justify-between gap-6 shadow-2xl">
          <div className="flex items-center gap-4">
            <div className="w-10 h-10 rounded-full bg-[#124903]/20 border border-[#124903]/40 flex items-center justify-center text-[#124903]">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            <Link
              href="/contact"
              className="flex-1 md:flex-initial px-5 py-2.5 rounded-full bg-[#124903] hover:bg-[#0e3802] text-white text-xs font-bold transition-all hover:shadow-[0_0_20px_rgba(18, 73, 3,0.45)] text-center"
            >
