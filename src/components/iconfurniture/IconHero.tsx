        ...
        <div className="flex flex-col gap-5 max-w-md pointer-events-auto">
          ...
          <div className="flex items-center gap-3.5 bg-white/85 backdrop-blur-md px-4 py-2.5 rounded-2xl border border-stone-200/70 shadow-xs w-fit">
            <div className="flex -space-x-2.5 overflow-hidden">
              <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-full ring-2 ring-white bg-[#124903] text-white flex items-center justify-center text-xs font-bold shadow-xs">
                MK
              </div>
            ...
            <div>
              <div className="font-extrabold text-[#1A1A1A] text-base sm:text-lg leading-tight tracking-tight flex items-center gap-1.5">
                <span>15k+</span>
                <span className="flex text-[#124903] text-xs">
                  <Star className="w-3.5 h-3.5 fill-[#124903]" />
                </span>
              </div>
          ...
          <div className="relative hidden md:block">
            ...
            <div className="mt-3 flex items-center gap-2 text-xs font-semibold text-stone-500">
              <span className="w-2 h-2 rounded-full bg-[#124903]" />
        ...
        <div className="flex flex-col items-start md:items-end justify-between gap-6 sm:gap-10 pointer-events-auto">
          ...
          <div className="hidden md:flex flex-col items-start md:items-end gap-1.5 text-stone-500 font-medium text-sm tracking-tight">
            <div className="flex items-center gap-2 hover:text-[#1A1A1A] transition-colors">
              ...
              <span className="text-[#124903] font-mono text-xs font-semibold">/01</span>
            </div>
            <div className="flex items-center gap-2 hover:text-[#1A1A1A] transition-colors">
              <span className="text-[#1A1A1A] font-medium">Natural Marble & Stone</span>
              <span className="text-[#124903] font-mono text-xs font-semibold">/02</span>
            </div>
            <div className="flex items-center gap-2 hover:text-[#1A1A1A] transition-colors">
              <span className="text-[#1A1A1A] font-medium">Custom Sizes & Colors</span>
              <span className="text-[#124903] font-mono text-xs font-semibold">/03</span>
            </div>
          </div>
          ...
          >
            ...
            {/* Pulsing aura */}
            <span className="absolute -inset-1 rounded-full bg-[#124903]/40 animate-ping pointer-events-none -z-10 opacity-75" />
          </Link>
        </div>
      </div>
    </div>
