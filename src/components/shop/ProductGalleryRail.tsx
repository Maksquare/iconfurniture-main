    ...
    <div className="space-y-4 select-none">
      ...
      >
        ...
        {isZooming && (
          ...
          >
            ...
            <div className="absolute top-4 right-4 bg-black/70 backdrop-blur-md px-3 py-1 rounded-full text-white text-[10px] font-mono flex items-center gap-1.5 border border-white/15">
              <Eye className="w-3 h-3 text-[#859F3C]" />
        ...
        <div className="absolute top-4 left-4 right-4 flex items-center justify-between pointer-events-none z-10">
          ...
          <div className="flex items-center gap-2">
            ...
            {product.in_stock ? (
              <span className="px-3.5 py-1 bg-[#859F3C] text-white text-[10px] uppercase font-bold tracking-widest rounded-full shadow-md">
                In Stock
              </span>
            ) : (
          ...
          <div className="flex items-center gap-2 pointer-events-auto">
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-full text-xs font-semibold flex items-center gap-1.5 transition-all shadow-md cursor-pointer ${
                isPlayingTour
                  ? 'bg-[#859F3C] text-white ring-2 ring-[#859F3C]/40 animate-pulse'
                  : 'bg-white/85 hover:bg-white text-stone-800 backdrop-blur-md border border-stone-200/80 hover:text-[#859F3C]'
              }`}
            ...
            <button
              ...
              className="p-2 rounded-full bg-white/85 hover:bg-white text-stone-800 backdrop-blur-md border border-stone-200/80 shadow-md hover:text-[#859F3C] transition-all cursor-pointer"
        ...
        <div className="absolute inset-y-0 left-3 right-3 flex items-center justify-between pointer-events-none z-10">
          <button
            onClick={handlePrev}
            className="pointer-events-auto w-10 h-10 rounded-full bg-white/90 hover:bg-white text-[#1A1A1A] hover:text-[#859F3C] shadow-lg border border-stone-200/70 backdrop-blur-md flex items-center justify-center transition-all duration-200 hover:scale-110 active:scale-95 cursor-pointer"
        ...
        <div className="absolute bottom-4 inset-x-4 flex items-center justify-between pointer-events-none z-10">
          ...
          <div className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/80 backdrop-blur-md text-stone-700 text-[10px] font-mono border border-stone-200/80">
            <Compass className="w-3 h-3 text-[#859F3C]" />
      ...
      <div className="relative">
            ...
            return (
              <button
                ...
                className={`relative group shrink-0 w-24 sm:w-28 aspect-4/3 rounded-2xl overflow-hidden border-2 transition-all duration-300 snap-center cursor-pointer ${
                  isActive
                    ? 'border-[#859F3C] ring-4 ring-[#859F3C]/20 shadow-md scale-102 bg-white'
              ...
              >
                ...
                {isActive && (
                  <span className="absolute top-1.5 right-1.5 w-2 h-2 rounded-full bg-[#859F3C] shadow-[0_0_8px_#859F3C]" />
                )}
        ...
        <div className="w-full h-1 bg-stone-200 rounded-full mt-2 overflow-hidden">
          <motion.div
            className="h-full bg-[#859F3C] rounded-full"
            initial={false}
            animate={{
          ...
          >
            ...
            <div className="flex items-center justify-between text-white border-b border-white/10 pb-4">
              <div className="flex items-center gap-3">
                <div className="w-2.5 h-2.5 rounded-full bg-[#859F3C] animate-pulse shadow-[0_0_10px_#859F3C]" />
                <div>
                ...
                return (
                  <button
                    ...
                    className={`relative shrink-0 w-20 sm:w-24 aspect-4/3 rounded-xl overflow-hidden border-2 transition-all cursor-pointer ${
                      isActive
                        ? 'border-[#859F3C] ring-2 ring-[#859F3C]/40 scale-105'
