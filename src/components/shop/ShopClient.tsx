    ...
    <div className="py-12 bg-[#FDFCF7] min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="relative rounded-3xl p-8 sm:p-12 bg-gradient-to-b from-[#f7f6f0] to-[#f0efe6] border border-stone-200/80 shadow-xs overflow-hidden">
          <div className="absolute top-0 right-0 w-96 h-96 bg-[#869e32]/10 rounded-full blur-3xl pointer-events-none" />
          <div className="max-w-3xl space-y-4">
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-stone-200/80 text-xs font-bold uppercase tracking-widest text-[#869e32] shadow-2xs">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-2.5 text-xs font-medium text-stone-700">
              ...
              <a href={OFFICIAL_CONTACTS.instagram.url} target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white border border-stone-200/80 hover:border-[#869e32] hover:text-[#869e32] transition-all shadow-2xs">
              ...
              <a href={OFFICIAL_CONTACTS.phonePrimary.tel}
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#1A1A1A] text-white hover:bg-[#869e32] transition-all shadow-2xs">
                <Phone className="w-3 h-3 text-[#869e32]" /><span>{OFFICIAL_CONTACTS.phonePrimary.display}</span>
              </a>
            </div>
          </div>
        </div>
            ...
            <div className="flex items-center gap-3 w-full sm:w-auto justify-between sm:justify-end">
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="py-2 px-3.5 bg-stone-50 border border-stone-200/80 rounded-2xl text-xs font-medium text-stone-800 focus:outline-none focus:border-[#869e32] cursor-pointer"
                >
        ...
        <div className="flex items-center justify-between text-xs text-stone-500 font-sans px-1">
          <div className="flex items-center gap-2">
            {isSearching ? (
              <span className="flex items-center gap-1.5 text-[#869e32]">
          ...
          {(searchTerm || selectedCategory !== 'all') && (
            <button
              ...
              className="flex items-center gap-1 text-[#869e32] hover:underline font-medium cursor-pointer"
            >
        ...
        <div className="mt-16 p-8 rounded-3xl bg-[#1A1A1A] text-white border border-white/10 flex flex-col md:flex-row items-center justify-between gap-6 shadow-2xl">
          <div className="space-y-1 text-center md:text-left">
            <h3 className="font-serif text-xl font-semibold text-[#869e32]">
          ...
          <div className="flex flex-wrap items-center gap-3 w-full md:w-auto justify-center">
            <a
              ...
              className="px-5 py-2.5 rounded-full bg-[#869e32] hover:bg-[#0e3802] text-white text-xs font-bold transition-all hover:shadow-[0_0_20px_rgba(18, 73, 3,0.4)] inline-flex items-center gap-2 cursor-pointer"
            >
